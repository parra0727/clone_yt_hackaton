...
| Metodo | Endpoint                       | Descripcion                                    | Params / Body |
|--------|--------------------------------|------------------------------------------------|---------------|
...
| DELETE | /videos/{video_id}             | Elimina un video (solo el dueno)               | Query: `requester_user_id` |
...
| GET    | /users/providers                            | Lista providers de autenticacion    | - |
